...
void
calculadora_prog_1(char *host,float i, float j)//Agregamos los valores para operar
{
	CLIENT *clnt;
	float  *result_1;
	valores  suma_1_arg;
	...
	int menuop;//Variable para acceder en un menu
	//Asignamos las variables para la funcion y para cada 
	//Parte que haga la operacion
	suma_1_arg.i=i;
	suma_1_arg.j=j;
	resta_1_arg.i=i;
	resta_1_arg.j=j;
	...
	//Proponemos el menu
	do{
		printf("-----CLIENTE CALCULADORA-----\n");
		printf("1.-SUMA\n");
		printf("2.-RESTA\n");
		printf("3.-MULTIPLICACION\n");
		printf("4.-DIVISION\n");
		printf("5.-SALIR\n");
		printf("Escoja la operacion a usar:");
		scanf("%d",&menuop);
		switch (menuop)
		{
			case 1:
	...
	while(menuop<5&&menuop>0);//cerramos el ciclo para el menu
